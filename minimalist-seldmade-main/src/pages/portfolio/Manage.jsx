                            ...
                            <div className="info__showcase">
                                ...
                                <div className="info__showcase-img-wrapper">
                                    <div className="info__showcase-img-wrapper-inner">
                                        <img className="info__showcase-img" src="img/portfolio-detail/manage-one.jpg" alt="Layout Manage" width="635" height="400" srcset="img/portfolio-detail/manage-one.jpg 1x, img/portfolio-detail/manage-one@2x.jpg 2x" />
                                    </div>
                                    <div className="info__showcase-img-wrapper-inner">
                                        <img className="info__showcase-img" src="img/portfolio-detail/manage-two.jpg" alt="Layout Manage" width="635" height="400" srcset="img/portfolio-detail/manage-two.jpg 1x, img/portfolio-detail/manage-two@2x.jpg 2x" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="slider">
                    <div className="container slider__container">
                        ...
                        <h3 className="slider__page-title">
                            <a className="slider__page-link" href="portfolio-fylo.html">Fylo</a>
                        </h3>
                        <h3 className="slider__page-title slider__page-title--next">
                            <a className="slider__page-link slider__page-link--next" href="portfolio-bookmark.html">Bookmark</a>
                        </h3>
                    </div>
