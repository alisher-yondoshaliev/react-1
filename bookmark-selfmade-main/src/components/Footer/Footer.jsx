        ...
        <footer class="site-footer">
            <div class="site-footer__container container">
                ...
                <a class="logo site-footer__logo" href="index.html">
                    <img class="logo__img" src={logo_white} alt="Bookmark logo" width="149" height="25" />
                </a>
                ...
                <div class="site-footer__sitenav sitenav">
                    <ul class="sitenav__list">
                        <li class="sitenav__item">
                            <a class="sitenav__link sitenav__link--footer" href="#">Features</a>
                        </li>
                        <li class="sitenav__item">
                            <a class="sitenav__link sitenav__link--footer" href="#">Pricing</a>
                        </li>
                        <li class="sitenav__item">
                            <a class="sitenav__link sitenav__link--footer" href="#">Contact</a>
                        </li>
                    </ul>
                </div>
                ...
                <ul class="site-footer__social-list">
                    <li class="site-footer__social-item">
                        <a class="site-footer__social-link" href="#" target="_blank" aria-label="Facebook">
                    ...
                    <li class="site-footer__social-item">
                        <a class="site-footer__social-link" href="#" target="_blank" aria-label="Twitter">
